...
DROP TABLE IF EXISTS `pdf_category`;
DROP TABLE IF EXISTS `pdf_collection`;
...
CREATE TABLE IF NOT EXISTS `collection` (
  ...
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_collection_user` (`user_id`)
);
...
CREATE TABLE IF NOT EXISTS `search` (
  ...
  `search_user_id` bigint DEFAULT NULL,
...
ALTER TABLE `alert`
  ADD CONSTRAINT `FK_alert_article` FOREIGN KEY (`article_id`) REFERENCES `article` (`id`),
  ADD CONSTRAINT `FK_alert_pdf` FOREIGN KEY (`pdf_id`) REFERENCES `pdf` (`id`),
  ADD CONSTRAINT `FK_alert_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

ALTER TABLE `category`
  ADD CONSTRAINT `FK_category_parent` FOREIGN KEY (`parent_id`) REFERENCES `category` (`id`);

ALTER TABLE `collection`
  ADD CONSTRAINT `FK_collection_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

ALTER TABLE `donation`
  ADD CONSTRAINT `FK_donation_user_beneficiary` FOREIGN KEY (`user_beneficiary_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_donation_user_donor` FOREIGN KEY (`user_donor_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_donation_pdf` FOREIGN KEY (`pdf_id`) REFERENCES `pdf` (`id`);

ALTER TABLE `evaluation`
  ADD CONSTRAINT `FK_evaluation_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_evaluation_pdf` FOREIGN KEY (`pdf_id`) REFERENCES `pdf` (`id`);

ALTER TABLE `pdf`
  ADD CONSTRAINT `FK_pdf_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

ALTER TABLE `pdf_category`
  ADD CONSTRAINT `FK_pdf_category_pdf` FOREIGN KEY (`pdf_id`) REFERENCES `pdf` (`id`),
  ADD CONSTRAINT `FK_pdf_category_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);

ALTER TABLE `pdf_collection`
  ADD CONSTRAINT `FK_pdf_collection_pdf` FOREIGN KEY (`pdf_id`) REFERENCES `pdf` (`id`),
  ADD CONSTRAINT `FK_pdf_collection_collection` FOREIGN KEY (`collection_id`) REFERENCES `collection` (`id`);

ALTER TABLE `search`
  ADD CONSTRAINT `FK_search_user` FOREIGN KEY (`search_user_id`) REFERENCES `user` (`id`);
...
-- Datas à insérer pour le type de rôle
